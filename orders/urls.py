...
urlpatterns =[
    ...
    path('driver-edit/', views.DriverEditor, name='driver_edit'),
    ...
    path('request-detail/<uuid:pk>/', views.RequestDetail, name='cf_ride_request_check'),
    path('sharerequest-detail/<uuid:pk>/', views.ShareRequestDetail, name='cf_share_ride_request_check'),
    ...
    path('driverID-check/', views.DriverIDCheck, name='driver_check'),
    ...
    path('share-ride-confirm/<uuid:main_id>/', views.JoinShareRide, name='middlepath'),
    path('share-ride-confirm/<uuid:main_id>/<uuid:share_id>/', views.JoinShareRide, name='share_ride_confirm'),
