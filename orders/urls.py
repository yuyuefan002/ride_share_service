...
urlpatterns =[
    ...
    path('driver/search-request/', driver.SearchingRequestListView.as_view(), name='driver_search_ride'),
    ...
    path('owner/ongoing-request-list/', driver.OGINRequestListView.as_view(), name='driver_order_list'),
